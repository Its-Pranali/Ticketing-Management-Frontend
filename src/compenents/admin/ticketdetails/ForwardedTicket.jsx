...
function ForwardedTicket() {
    ...
    const fetchTickets = async (pageNumber = 1, searchTerm = search) => {
        setLoading(true);
        try {
            const res = await api.get('getForwardedTickets', {
                params: {
                    page: pageNumber,
                    search: searchTerm,
                    limit: 10,
                ...
                <div className="page-header-card">
                    <div className="page-title-area">
                        ...
                        <div>
                            ...
                            <p>Manage list of Forwarded Tickets and details</p>
                        </div>
                    </div>
                    <div>
                        ...
                        <table className="custom-table" style={{ width: '1500px', overflowX: 'scroll' }}>
                            ...
                            <AnimatePresence mode="wait">
                                {loading ? (
                                    ...
                                    <TableDataNotFound title="Forwarded Tickets" colSpan={9} />
                                ) : (
                                    <motion.tbody>
...
export default ForwardedTicket;